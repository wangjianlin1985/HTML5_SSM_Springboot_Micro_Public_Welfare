...
public class NewsService {
    ...
    /*按照查询条件分页查询新闻信息记录*/
    public ArrayList<News> queryNews(String title,String newClass,String publishDate,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!title.equals("")) where = where + " and t_news.title like '%" + title + "%'";
    	if(!newClass.equals("")) where = where + " and t_news.newClass like '%" + newClass + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<News> queryNews(String title,String newClass,String publishDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!title.equals("")) where = where + " and t_news.title like '%" + title + "%'";
    	if(!newClass.equals("")) where = where + " and t_news.newClass like '%" + newClass + "%'";
    	if(!publishDate.equals("")) where = where + " and t_news.publishDate like '%" + publishDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String title,String newClass,String publishDate) throws Exception {
     	String where = "where 1=1";
    	if(!title.equals("")) where = where + " and t_news.title like '%" + title + "%'";
    	if(!newClass.equals("")) where = where + " and t_news.newClass like '%" + newClass + "%'";
    	if(!publishDate.equals("")) where = where + " and t_news.publishDate like '%" + publishDate + "%'";
