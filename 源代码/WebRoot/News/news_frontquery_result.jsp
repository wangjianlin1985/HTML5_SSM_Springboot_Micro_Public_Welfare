...
<%
    ...
    String newClass = (String)request.getAttribute("newClass"); //新闻分类查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#newsListPanel" aria-controls="newsListPanel" role="tab" data-toggle="tab">新闻信息列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>News/news_frontAdd.jsp" style="display:none;">添加新闻信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>新闻id</td><td>新闻标题</td><td>新闻分类</td><td>发布时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="newsQueryForm" id="newsQueryForm" action="<%=basePath %>News/frontlist" class="mar_t15">
			...
			<div class="form-group">
				<label for="newClass">新闻分类:</label>
				<input type="text" id="newClass" name="newClass" value="<%=newClass %>" class="form-control" placeholder="请输入新闻分类">
			</div>
