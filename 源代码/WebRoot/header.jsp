...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">校园微公益网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!--<li><a href="<%=basePath %>ActivityType/frontlist">活动类型</a></li>-->
                <li><a href="<%=basePath %>ActivityInfo/frontlist">公益活动</a></li>
                <li><a href="<%=basePath %>SignUp/frontlist">活动报名</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>SignUp/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的活动报名</a></li>
